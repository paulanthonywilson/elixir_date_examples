defmodule Dates do
  ...
  defp days_between(date1, date2, filter) do
    for g <- (elixir_to_gregorian_date(date1)..elixir_to_gregorian_date(date2)), filter.(g), do:  gregorian_day_to_elixir_date(g)
  end

  defp elixir_to_gregorian_date(elixir_date) do
    elixir_date
    |> Date.to_erl
    |> :calendar.date_to_gregorian_days
  end

  defp gregorian_day_to_elixir_date(gregorian_day) do
    gregorian_day
